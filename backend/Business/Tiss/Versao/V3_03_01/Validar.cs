...
using Mapeamento.Tiss.V3_03_01;

namespace Business.Tiss.Versao.V3_03_01
{
    public class Validar : ValidarBase
    {
        ...
        public override void ValidarSchema(Stream stream)
        {
            ...
            arquivosXsd.Add(assembly.GetManifestResourceStream("Tiss.V3_03_01.ArquivosAns.xsd.tissV3_03_01.xsd"));
            arquivosXsd.Add(assembly.GetManifestResourceStream("Tiss.V3_03_01.ArquivosAns.xsd.tissAssinaturaDigital_v1.01.xsd"));
            arquivosXsd.Add(assembly.GetManifestResourceStream("Tiss.V3_03_01.ArquivosAns.xsd.tissSimpleTypesV3_03_01.xsd"));
            arquivosXsd.Add(assembly.GetManifestResourceStream("Tiss.V3_03_01.ArquivosAns.xsd.tissComplexTypesV3_03_01.xsd"));
            arquivosXsd.Add(assembly.GetManifestResourceStream("Tiss.V3_03_01.ArquivosAns.xsd.tissGuiasV3_03_01.xsd"));
            arquivosXsd.Add(assembly.GetManifestResourceStream("Tiss.V3_03_01.ArquivosAns.xsd.xmldsig-core-schema.xsd"));
